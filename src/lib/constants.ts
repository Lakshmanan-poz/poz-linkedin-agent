...
export const POST_STATUS_COLORS: Record<PostStatus, string> = {
  ...
  under_review:        "bg-orange-100  text-orange-800  dark:bg-orange-900/40   dark:text-orange-300",
  changes_requested:   "bg-red-100     text-red-700     dark:bg-red-900/40      dark:text-red-300",
  approved_for_design: "bg-blue-100    text-blue-700    dark:bg-blue-900/40     dark:text-blue-300",
  design_in_progress:  "bg-purple-100  text-purple-700  dark:bg-purple-900/40   dark:text-purple-300",
